...
class KitchenLowdimRunner(BaseLowdimRunner):
    def __init__(self,
        ...
        def env_fn():
            from env.kitchen.v0 import KitchenAllV0
            from env.kitchen.kitchen_lowdim_wrapper import KitchenLowdimWrapper
    ...
    def run(self, 
        ...
        for chunk_idx in range(n_chunks):
            ...
            pbar = tqdm.tqdm(total=self.max_steps, desc=f"Eval KitchenLowdimRunner {chunk_idx+1}/{n_chunks}", 
