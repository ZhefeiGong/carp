...
from env.dataset.base_dataset import BaseImageDataset, LinearNormalizer
...
from env.codecs.imagecodecs_numcodecs import register_codecs, Jpeg2k
...
class RobomimicReplayImageDataset(BaseImageDataset):
    ...
    def get_normalizer(self, **kwargs) -> LinearNormalizer:
        ...
        for key in self.rgb_keys:
            normalizer[key] = get_image_range_normalizer() # [0,1] to [-1,1]
        return normalizer
