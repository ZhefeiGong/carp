...
class EvalDistributedSampler(Sampler):
    """
    @func : 
    A sampler for distributed evaluation that divides a data set across multiple devices (Gpus or machines), 
    each processing only a portion of the data
    """
...
class InfiniteBatchSampler(Sampler):
    """
    @func : 
    An infinite loop batch sampler, usually used to continuously generate batches of data during training, 
    especially in some continuous training scenarios
    """
    ...
    def gener_indices(self):
        """
        @func: 
        generate an index sequence of data
        """
    ...
    def __iter__(self):
        """
        @func: 
        the batch index is generated through an infinite loop until the entire epoch is complete
...
class DistInfiniteBatchSampler(InfiniteBatchSampler):
    """
    @func : 
    An infinite batch sampler that supports distributed training to divide data sets across multiple devices and generate distributed batch data
    """
    ...
    def gener_indices(self):
        """
        @func: 
        generate a distributed data index
        """
