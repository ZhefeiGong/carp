...
def get_args():
    ...
    parser.add_argument("--vae_ckpt_paths", type=str, required=True, nargs="+", help="path/to/the/vae/checkpoints") # NOTE: need
    ...
    parser.add_argument("--env_n_obs_steps", type=int, default=1, help="Number of observation steps")
